...
| [协议兼容回归清单.md](report/协议兼容回归清单.md) | 发布前应跑的协议兼容回归项 |

### 治理与决策
| 文档 | 作用 |
| --- | --- |
| [长期维护治理TODO.md](plan/长期维护治理TODO.md) | 长期维护事项清单 |
| [service治理待办.md](plan/service治理待办.md) | service 模块剩余治理项 |
| [Codex对齐会话语义与自动切换设计.md](plan/Codex对齐会话语义与自动切换设计.md) | Codex 对齐的会话绑定、自动切换与线程切换设计 |
| [长期维护结构优化建议.md](report/长期维护结构优化建议.md) | 当前结构问题与优化建议 |
| [service治理阶段报告.md](report/service治理阶段报告.md) | 已完成治理项和阶段结果 |
